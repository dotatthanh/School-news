...
<!DOCTYPE html>
    ...
    <head>
<title>Contact</title>
<meta name="description" content="Contact - Contact - https&#x3A;&#x002F;&#x002F;hust.edu.vn&#x002F;en&#x002F;contact&#x002F;">
...
<meta property="og:description" content="Contact - Contact - https&#x3A;&#x002F;&#x002F;hust.edu.vn&#x002F;en&#x002F;contact&#x002F;">
<meta property="og:site_name" content="Hanoi University of Science and Technology &#40;HUST&#41;">
<meta property="og:url" content="https://hust.edu.vn/en/contact/">
<link rel="canonical" href="https://hust.edu.vn/en/contact/">
<link rel="shortcut icon" href="{{ asset('web/uploads/sys/logo-website02_136_200_1.png') }}">
<link rel="preload" as="style" href="{{ asset('web/assets/css/font-awesome.min.css?t=1713143713') }}" type="text/css">
<link rel="preload" as="style" href="{{ asset('web/themes/hust/css/animate.min.css?t=1713143713') }}" type="text/css">
<link rel="preload" as="style" href="{{ asset('web/themes/hust/css/bootstrap.min.css?t=1713143713') }}" type="text/css">
<link rel="preload" as="style" href="{{ asset('web/themes/hust/css/style.css?t=1713143713') }}" type="text/css">
<link rel="preload" as="style" href="{{ asset('web/themes/hust/css/style.responsive.css?t=1713143713') }}" type="text/css">
<link rel="preload" as="style" href="{{ asset('web/themes/default/css/contact.css?t=1713143713') }}" type="text/css">
<link rel="preload" as="style" href="{{ asset('web/themes/hust/css/custom.css?t=1713143713') }}" type="text/css">
<link rel="preload" as="style" href="{{ asset('web/themes/hust/css/hust.css?t=1713143713') }}" type="text/css">
<link rel="preload" as="style" href="{{ asset('web/assets/css/hust.en.0.css?t=1713143713') }}" type="text/css">
<link rel="preload" as="style" href="{{ asset('web/themes/hust/js/slick/slick.css?t=1713143713') }}" type="text/css">
<link rel="preload" as="style" href="{{ asset('web/themes/hust/js/slick/slick-theme.css?t=1713143713') }}" type="text/css">
<link rel="preload" as="style" href="{{ asset('web/themes/default/css/slimmenu.css?t=1713143713') }}" type="text/css">
<link rel="preload" as="script" href="{{ asset('web/assets/js/jquery/jquery.min.js?t=1713143713') }}" type="text/javascript">
<link rel="preload" as="script" href="{{ asset('web/assets/js/language/en.js?t=1713143713') }}" type="text/javascript">
<link rel="preload" as="script" href="{{ asset('web/assets/js/DOMPurify/purify3.js?t=1713143713') }}" type="text/javascript">
<link rel="preload" as="script" href="{{ asset('web/assets/js/global.js?t=1713143713') }}" type="text/javascript">
<link rel="preload" as="script" href="{{ asset('web/assets/js/site.js?t=1713143713') }}" type="text/javascript">
<link rel="preload" as="script" href="{{ asset('web/themes/default/js/contact.js?t=1713143713') }}" type="text/javascript">
<link rel="preload" as="script" href="{{ asset('web/themes/hust/js/main.js?t=1713143713') }}" type="text/javascript">
<link rel="preload" as="script" href="{{ asset('web/themes/hust/js/custom.js?t=1713143713') }}" type="text/javascript">
<link rel="preload" as="script" href="{{ asset('web/themes/hust/js/hust.js?t=1713143713') }}" type="text/javascript">
<link rel="preload" as="script" href="{{ asset('web/themes/hust/js/slick/slick.js?t=1713143713') }}" type="text/javascript">
<link rel="preload" as="script" href="https://www.googletagmanager.com/gtag/js?id=G-TT1NML6EJM" type="text/javascript">
<link rel="preload" as="script" href="{{ asset('web/themes/default/js/jquery.slimmenu.js?t=1713143713') }}" type="text/javascript">
<link rel="preload" as="script" href="{{ asset('web/assets/js/jquery-ui/jquery-ui.min.js?t=1713143713') }}" type="text/javascript">
<link rel="preload" as="script" href="{{ asset('web/themes/hust/js/bootstrap.min.js?t=1713143713') }}" type="text/javascript">
<link rel="stylesheet" href="{{ asset('web/assets/css/font-awesome.min.css?t=1713143713') }}">
<link rel="stylesheet" href="{{ asset('web/themes/hust/css/animate.min.css?t=1713143713') }}">
<link rel="stylesheet" href="{{ asset('web/themes/hust/css/bootstrap.min.css?t=1713143713') }}">
<link rel="stylesheet" href="{{ asset('web/themes/hust/css/style.css?t=1713143713') }}">
<link rel="stylesheet" href="{{ asset('web/themes/hust/css/style.responsive.css?t=1713143713') }}">
<link rel="StyleSheet" href="{{ asset('web/themes/default/css/contact.css?t=1713143713') }}">
<link rel="stylesheet" href="{{ asset('web/themes/hust/css/custom.css?t=1713143713') }}">
<link rel="stylesheet" href="{{ asset('web/themes/hust/css/hust.css?t=1713143713') }}">
<link rel="stylesheet" href="{{ asset('web/assets/css/hust.en.0.css?t=1713143713') }}">
<link rel="stylesheet" href="{{ asset('web/themes/hust/js/slick/slick.css?t=1713143713') }}" />
<link rel="stylesheet" href="{{ asset('web/themes/hust/js/slick/slick-theme.css?t=1713143713') }}" />
<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('web/themes/default/css/slimmenu.css?t=1713143713') }}" />
</head>
    <body>
            ...
            <div class="wraper">
                <div id="header">
                    <div class="logo hide-logo">
                        <div class="text-site"><a title="Hanoi University of Science and Technology &#40;HUST&#41;" href="https://hust.edu.vn/en/"><img src="{{ asset('web/uploads/sys/logo-website02_136_200_1.png') }}" alt="Hanoi University of Science and Technology &#40;HUST&#41;"></a>
...
<li>
    ...
    <div class="section-body">
        <div>
            <section>
                <div class="container contact" id="body">
                            ...
                            <div class="clearfix">
                                <div class="col-xs-24 col-sm-18 col-md-18">
                                        ...
                                        <ul class="temp-breadcrumbs hidden" itemscope itemtype="https://schema.org/BreadcrumbList">
                                            ...
                                            <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><a href="https://hust.edu.vn/en/contact/" itemprop="item" title="Contact"><span class="txt" itemprop="name">Contact</span></a><i class="hidden" itemprop="position" content="2"></i></li>
                                        </ul>
                                    </div>
                                </div>
...
<div class="row wraper">
    ...
    <form method="post" action="https://hust.edu.vn/en/contact/" onsubmit="return nv_validForm(this);" novalidate>
				<div class="form-group">
			<div class="input-group">
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<input type="text" maxlength="100" value="" name="fname" class="form-control required" placeholder="Your full name" onkeypress="nv_validErrorHidden(this);" data-mess="Please enter your full name" data-callback="nv_uname_check" />
		...
		<div class="form-group">
            ...
            <div class="middle text-right clearfix">
                <!-- <img width="150" height="40" title="Security code" alt="Security code" src="index.php?scaptcha=captcha&t=1714231750" class="captchaImg display-inline-block"> -->
                <em onclick="change_captcha('.fcode');" title="Refresh" class="fa fa-pointer fa-refresh margin-left margin-right"></em>
                <input type="text" placeholder="Security code" maxlength="6" value="" name="fcode" class="fcode required form-control display-inline-block" style="width:100px;" data-pattern="/^(.){6,6}$/" onkeypress="nv_validErrorHidden(this);" data-mess="Error: Security code incorrect"/>
            </div>
		</div>
		<div class="text-center form-group">
			<input type="hidden" name="checkss" value="2a8ad236baa2d1ad16bb234616731f1d" />
			<input type="button" value="Clear" class="btn btn-default" onclick="nv_validReset(this.form);return!1;" />
...
<div class="row">
    ...
    <nav class="section-footer-bottom footerNav2">
        <div class="wraper">
            <div class="container">
                <div class="col-md-5 col-sm-5 col-xs-24" style="padding-left: 0px"><img alt="logo footer" height="72" src="{{ asset('web/uploads/logo-footer.png') }}" width="200" />
</div>
...
<script src="{{ asset('web/assets/js/jquery/jquery.min.js?t=1713143713') }}"></script>
...
<script src="{{ asset('web/assets/js/language/en.js?t=1713143713') }}"></script>
<script src="{{ asset('web/assets/js/DOMPurify/purify3.js?t=1713143713') }}"></script>
<script src="{{ asset('web/assets/js/global.js?t=1713143713') }}"></script>
<script src="{{ asset('web/assets/js/site.js?t=1713143713') }}"></script>
<script src="{{ asset('web/themes/default/js/contact.js?t=1713143713') }}"></script>
<script src="{{ asset('web/themes/hust/js/main.js?t=1713143713') }}"></script>
<script src="{{ asset('web/themes/hust/js/custom.js?t=1713143713') }}"></script>
<script src="{{ asset('web/themes/hust/js/hust.js?t=1713143713') }}"></script>
<script src="{{ asset('web/themes/hust/js/slick/slick.js?t=1713143713') }}"></script>
...
<script	type="text/javascript" src="{{ asset('web/themes/default/js/jquery.slimmenu.js?t=1713143713') }}"></script>
<script src="{{ asset('web/assets/js/jquery-ui/jquery-ui.min.js?t=1713143713') }}"></script>
...
<script src="{{ asset('web/themes/hust/js/bootstrap.min.js?t=1713143713') }}"></script>
</body>
</html>